...
{
    public partial class RecPorLocal : Form
    {
        ...
        private void RecPorLocal_Load(object sender, EventArgs e)
        {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                reportViewer1.LocalReport.ReportEmbeddedResource = "Shopping_Buy_All.Estadisticas.Ventanas_Estadisticas.EstadisticasRecaudacion.RecaudacionPorLocal.RecaudacionPorLocal.rdlc";
